...
// Un solo campo (email) resuelve las dos cosas: si ya tiene cuenta se
// vincula directo, si no se genera un link de invitación atado a ese
// email.
export async function POST(req: NextRequest) {
  ...
  const resultado = await invitarOVincular(email, sesion.slug, sesion.negocio, rol, sesion.usuarioId);
